...
<section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
    <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Edit Product</h2>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Update your product information</p>
        </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex items-center space-x-4 mb-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Upload a new image (Max 2MB)</p>
                            </div>
                        </div>
                        @error('image')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
