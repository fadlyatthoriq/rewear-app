        ...
        <div class="mt-6 md:gap-6 lg:flex lg:items-start xl:gap-8">
            ...
            <div class="mx-auto w-full flex-none lg:max-w-xs mt-6 lg:mt-0">
                <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 sm:p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 sticky top-6">
                    ...
                    <a href="{{ route('checkout') }}" class="inline-flex items-center justify-center w-full px-6 py-3 text-white font-semibold shadow-md hover:!bg-primary-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:!outline-primary-600 transition-colors duration-200">
