  ...
  <div class="container mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-3 md:gap-6">
    ...
    <div class="flex items-center space-x-4 md:space-x-5 text-gray-600">
      <a href="/wishlist" class="relative group">
        ...
        <span class="absolute -top-2 -right-2 bg-[#2596be] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center shadow">8</span>
      </a>
      <a href="/cart" class="relative group">
        <i class="fa-solid fa-bag-shopping text-xl group-hover:text-[#2596be] transition"></i>
        <span class="absolute -top-2 -right-2 bg-[#2596be] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center shadow">2</span>
      </a>
      @auth
  ...
  <div class="container mx-auto px-4 flex items-center justify-between h-14 md:h-16">
    ...
    <div class="relative group flex-shrink-0">
      ...
      <div
        ...
        @endphp
        @foreach (['Women', 'Men', 'Accessories', 'Shoes', 'Bags', 'Jewelry'] as $item)
        <a href="#" class="flex items-center px-6 py-4 hover:bg-gray-50 transition text-sm border-b border-gray-100 last:border-b-0">
          <i class="fa-solid fa-{{ $icons[$item] }} w-5 h-5 mr-5 text-[#2596be]"></i>
    ...
    <div class="hidden md:flex items-center space-x-6 ml-6">
      ...
      <a href="/about" class="{{ request()->is('about*') ? 'text-[#2596be]' : 'hover:text-[#2596be]' }} transition font-semibold text-sm md:text-base">About Us</a>
      <a href="/contact" class="{{ request()->is('contact*') ? 'text-[#2596be]' : 'hover:text-[#2596be]' }} transition font-semibold text-sm md:text-base">Contact Us</a>
      @auth
